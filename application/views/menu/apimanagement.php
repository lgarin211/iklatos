            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo base_url('menu/Tambah_api'); ?>">
                    ...
                    <div class=" form-group">
                        ...
                        <small>Untuk mendapatkan API KEY silahkan mendaftar di layanan berikut:</small>
                                        <br>Whatsapp Gateway <a href='https://wagaway.apdgroup.co.id/register'>https://wagaway.apdgroup.co.id/register</a>
                    </div>
                    <div class=" form-group">
                        <label>Sender</label>
                    ...
                    <div class=" form-group">
                        <!--<label>Url</label>-->
                        <input type="hidden" name="url" class="form-control input-rounded" value="https://wagaway.apdgroup.co.id/send-message" placeholder="Masukan EndPoint Api WAGateway" required>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo base_url('menu/editapi'); ?>">
                        ...
                        <div class=" form-group">
                            <!-- <label>Url</label>-->
                            <input type="hidden" name="url" class="form-control input-rounded" value="<?= $getapi['url'] ?>" placeholder="Masukan EndPoint Api WAGateway" required>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger light" data-dismiss="modal">Close</button>
